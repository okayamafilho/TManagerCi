package br.com.okayama.tmanagerci.activities.dialog
...
import br.com.okayama.tmanagerci.activities.adapters.LabelColorListItemsAdapter
...
abstract class LabelColorListDialog(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(view)
        //quando clica no dialog, ele some
